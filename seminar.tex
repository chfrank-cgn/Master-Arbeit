...
\begin{abstract}
In this paper, we will evaluate the use of SUSE Security in combination with on-premises LLMs in air-gapped environments to assess the readiness of Kubernetes clusters for NIS2 compliance and ongoing reporting requirements.
