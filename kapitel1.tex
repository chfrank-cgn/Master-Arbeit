...
Kubernetes (K8S) is an open-source system designed to automate the deployment, scaling, and management of applications built with containers. Containers package software in a standardized unit that includes all dependencies required to run the software, such as code, libraries, and settings. This makes them portable and efficient.
...
In 2015, Kubernetes reached the 1.0 milestone, and in 2016, it was donated to the CNCF; the current release of Kubernetes is 1.35, codenamed Timbernets.
...
\includegraphics[width=0.3\linewidth]{images/k8s-1.35.png}
